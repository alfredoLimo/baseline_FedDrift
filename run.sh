...
# echo "Selected Algorithm: $CL_ALGO"
# echo "Algorithm Argument: $CL_ALGO_ARG"
...
strategy="feddrift"  # Options: "cfl", "ifca", "ada", "feddrift", "feddrift-eagar"
CL_ALGO="softcluster"
...
for scaling in $(seq 1 4); do
    ...
    for fold in $(seq 0 $(($k_folds - 1))); do        
        ...
        python ./data_gen.py --fold "$fold" --scaling "$scaling"
...
strategy="cfl"  # Options: "cfl", "ifca", "ada", "feddrift", "feddrift-eagar"
CL_ALGO="softcluster"
...
# strategy="ifca"  # Options: "cfl", "ifca", "ada", "feddrift", "feddrift-eagar"
# CL_ALGO="softclusterwin-1"
# CL_ALGO_ARG="hard-r"
 
# for scaling in $(seq 3 6); do
